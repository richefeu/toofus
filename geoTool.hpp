...
#undef EPSILON
  ...
  static int intersectTriangle(const vec3r &orig, const vec3r &dir, const vec3r &vert0, const vec3r &vert1,
                               const vec3r &vert2) {
    vec3r u, v, n;
    vec3r w0, w;
    double r, a, b;
  ...
  static mat9r inertiaDivMassTetrahedron(const vec3r &v1, const vec3r &v2, const vec3r &v3, const vec3r &v4) {
    double Ixx =
        0.1 * (v1.y * v1.y + v1.y * v2.y + v2.y * v2.y + v1.y * v3.y + v2.y * v3.y + v3.y * v3.y + v1.y * v4.y +
               v2.y * v4.y + v3.y * v4.y + v4.y * v4.y + v1.z * v1.z + v1.z * v2.z + v2.z * v2.z + v1.z * v3.z +
               v2.z * v3.z + v3.z * v3.z + v1.z * v4.z + v2.z * v4.z + v3.z * v4.z + v4.z * v4.z);
    double Iyy =
        0.1 * (v1.x * v1.x + v1.x * v2.x + v2.x * v2.x + v1.x * v3.x + v2.x * v3.x + v3.x * v3.x + v1.x * v4.x +
               v2.x * v4.x + v3.x * v4.x + v4.x * v4.x + v1.z * v1.z + v1.z * v2.z + v2.z * v2.z + v1.z * v3.z +
               v2.z * v3.z + v3.z * v3.z + v1.z * v4.z + v2.z * v4.z + v3.z * v4.z + v4.z * v4.z);
    double Izz =
        0.1 * (v1.x * v1.x + v1.x * v2.x + v2.x * v2.x + v1.x * v3.x + v2.x * v3.x + v3.x * v3.x + v1.x * v4.x +
               v2.x * v4.x + v3.x * v4.x + v4.x * v4.x + v1.y * v1.y + v1.y * v2.y + v2.y * v2.y + v1.y * v3.y +
               v2.y * v3.y + v3.y * v3.y + v1.y * v4.y + v2.y * v4.y + v3.y * v4.y + v4.y * v4.y);
    double Ixy = 0.05 * (2.0 * v1.x * v1.y + v2.x * v1.y + v3.x * v1.y + v4.x * v1.y + v1.x * v2.y + 2.0 * v2.x * v2.y +
                         v3.x * v2.y + v4.x * v2.y + v1.x * v3.y + v2.x * v3.y + 2.0 * v3.x * v3.y + v4.x * v3.y +
                         v1.x * v4.y + v2.x * v4.y + v3.x * v4.y + 2.0 * v4.x * v4.y);
    double Ixz = 0.05 * (2.0 * v1.x * v1.z + v2.x * v1.z + v3.x * v1.z + v4.x * v1.z + v1.x * v2.z + 2.0 * v2.x * v2.z +
                         v3.x * v2.z + v4.x * v2.z + v1.x * v3.z + v2.x * v3.z + 2.0 * v3.x * v3.z + v4.x * v3.z +
                         v1.x * v4.z + v2.x * v4.z + v3.x * v4.z + 2.0 * v4.x * v4.z);
    double Iyz = 0.05 * (2.0 * v1.y * v1.z + v2.y * v1.z + v3.y * v1.z + v4.y * v1.z + v1.y * v2.z + 2.0 * v2.y * v2.z +
                         v3.y * v2.z + v4.y * v2.z + v1.y * v3.z + v2.y * v3.z + 2.0 * v3.y * v3.z + v4.y * v3.z +
                         v1.y * v4.z + v2.y * v4.z + v3.y * v4.z + 2.0 * v4.y * v4.z);
    return mat9r(Ixx, Ixy, Ixz, Ixy, Iyy, Iyz, Ixz, Iyz, Izz);
  }

}; // end class geoTool

#endif /* end of include guard: GEOTOOL_HPP */
